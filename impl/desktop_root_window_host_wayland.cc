...
void DesktopRootWindowHostWayland::InitWaylandWindow(
  ...
  switch (params.type) {
    ...
    case Widget::InitParams::TYPE_MENU:
      if (!window_parent_) {
        // Wayland surfaces don't know their position on the screen and
        // transient surfaces always require a parent surface for relative
        // placement. Here there's a catch because content_shell menus don't
        // have parent and therefore we use root window to calculate their
        // position.
